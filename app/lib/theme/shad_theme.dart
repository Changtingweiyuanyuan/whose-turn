...
abstract final class AppShadTheme {
  ...
  static ShadThemeData get light => ShadThemeData(
    ...
    primaryToastTheme: ShadToastTheme(
      ...
      shadows: const [],
      // 右上角 X 對齊 modal：AppCloseIcon 22 @ top20 right20，常駐顯示
      closeIcon: const AppCloseIcon(forToast: true),
    ...
    outlineButtonTheme: const ShadButtonTheme(foregroundColor: AppColors.ink),
    // 誰都可以接開關：開=愛心綠、把手白
    ...
    textTheme: ShadTextTheme(family: GoogleFonts.robotoCondensed().fontFamily!),
  );
}
